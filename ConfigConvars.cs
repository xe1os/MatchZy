...
namespace MatchZy
{
    public partial class MatchZy
    {
        ...
        public FakeConVar<bool> spawnMarkersEnabledByDefault = new("matchzy_spawn_markers_enabled_default", "Whether competitive spawn markers are visible when practice mode starts. Default: true", true);
